...
/***************************** Configuration ***************************************************/
define('TPLN_LANG','fr'); // default Error language 'en' , 'fr'

//define('TPLN_WEB_PATH', 'http://localhost/squel/class/TPLN') ; // your website TPLN url NO slash at end ! (absolute path)
...
define('TPLN_ERROR_LANG', 'fr'); // default Error language 'en' , 'fr'
define('TPLN_ERROR_ALERT', false);  // activate Mail error alert ? (1=true and 0=false)
define('TPLN_MAIL_ADMIN', 'elivey@gmail.com'); // email adress for error alert (for the webmaster)
define('TPLN_MAIL_EXPEDITOR', 'tpln@domain.fr'); // the expeditor email by default
...
define('TPLN_DB_TYPE_DEFAULT','pgsql'); // your SGBD by defaut option
define('TPLN_DB_HOST_DEFAULT', 'localhost'); // your host by defaut
define('TPLN_DB_LOGIN_DEFAULT', ''); // your login by defaut
define('TPLN_DB_PASSWORD_DEFAULT',''); // your password by defaut
define('TPLN_DB_BASE_DEFAULT', ''); // your base by defaut
define('TPLN_DB_PORT', '5432'); // your port by defaut don't touch if you don't know
