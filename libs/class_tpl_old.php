...
class TPL extends TPLN
{
  ...
  function Tpl() {
	$session_sep_systeme = SepSysteme;
...
/****************************************************/
  function Write() {
    ...
    if(strpos($nom_template,'/top.html')||strpos($nom_template,'/menu.html')||strpos($nom_template,'/racc_menu.html')) {
	  ...
	  if($this->ItemExists('grid_auto')) {
			if($this->menu_gauche==1)
				$this->Parse('grid_auto','12');
			else
				$this->Parse('grid_auto','16');
	  }	  
      parent::Write();
    }
  }
